...
bool KOReaderCredentialStore::fromJson(JsonVariantConst doc) {
  ...
  setAutoSyncEnabled(doc["autoSyncEnabled"] | true);
...
void KOReaderCredentialStore::setAutoSyncEnabled(bool enabled) {
  autoSyncEnabled = enabled;
  LOG_DBG("KRS", "Set auto-sync enabled: %s", enabled ? "true" : "false");
}
