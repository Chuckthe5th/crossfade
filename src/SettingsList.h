  ...
  static const std::vector<SettingInfo> baseList = [] {
    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_FILE_BROWSER_VIEW, &CrossPointSettings::fileBrowserView,
                          {StrId::STR_FILE_BROWSER_VIEW_FILES, StrId::STR_FILE_BROWSER_VIEW_COVERS,
                           StrId::STR_FILE_BROWSER_VIEW_TITLES},
                          "fileBrowserView", StrId::STR_CAT_DISPLAY),
        SettingInfo::Enum(StrId::STR_RECENT_BOOKS_VIEW, &CrossPointSettings::recentBooksView,
                          {StrId::STR_FILE_BROWSER_VIEW_LIST, StrId::STR_FILE_BROWSER_VIEW_COVERS}, "recentBooksView",
                          StrId::STR_CAT_DISPLAY),
        ...
        SettingInfo::Toggle(StrId::STR_BROWSE_BOOKS_START_IN_SERIES, &CrossPointSettings::browseBooksStartInSeries,
                            "browseBooksStartInSeries", StrId::STR_CAT_DISPLAY),
